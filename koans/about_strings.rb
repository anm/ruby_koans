...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # I suspect the expected answer is that it is faster because a new object
    # is not created. This is an awful reason. The programmer should first
    # make the program understandable and correct, then consider optimisation
    # iff necessary. Mutating objects is likely to cause bugs - a value that
    # may be though was a copy of an object can suddenly change in another
    # part of the program when it is changed by another reference.
  end
